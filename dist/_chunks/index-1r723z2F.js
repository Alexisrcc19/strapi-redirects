...
function baseClone$4(src, circulars, clones) {
  ...
  if (src instanceof Object) {
    ...
    for (var key in src) {
      ...
      obj[key] = idx > -1 ? clones[idx] : baseClone$4(src[key], circulars, clones);
    }
    return obj;
  }
  return src;
...
var isFunction$5 = isFunction_1, isMasked = _isMasked, isObject$e = isObject_1, toSource$1 = _toSource;
var reRegExpChar = /[\\^$.*+?()[\]{}|]/g;
...
var Symbol$4 = _Symbol, arrayMap$2 = _arrayMap, isArray$f = isArray_1, isSymbol$4 = isSymbol_1;
...
var isArray$e = isArray_1, isKey$2 = _isKey, stringToPath$2 = _stringToPath, toString$6 = toString_1;
...
var baseGetTag$4 = _baseGetTag, isObjectLike$9 = isObjectLike_1;
...
var _toKey = toKey$7;
var castPath$5 = _castPath, isArguments$3 = isArguments_1, isArray$d = isArray_1, isIndex$4 = _isIndex, isLength$2 = isLength_1, toKey$6 = _toKey;
function hasPath$2(object2, path, hasFunc) {
  path = castPath$5(path, object2);
  var index2 = -1, length = path.length, result = false;
  while (++index2 < length) {
    var key = toKey$6(path[index2]);
  ...
  return !!length && isLength$2(length) && isIndex$4(key, length) && (isArray$d(object2) || isArguments$3(object2));
}
...
var baseGetTag$3 = _baseGetTag, isLength$1 = isLength_1, isObjectLike$7 = isObjectLike_1;
...
function baseIsTypedArray$1(value) {
  return isObjectLike$7(value) && isLength$1(value.length) && !!typedArrayTags[baseGetTag$3(value)];
}
...
var baseTimes = _baseTimes, isArguments$2 = isArguments_1, isArray$c = isArray_1, isBuffer$5 = isBufferExports, isIndex$3 = _isIndex, isTypedArray$3 = isTypedArray_1;
var objectProto$9 = Object.prototype;
var hasOwnProperty$8 = objectProto$9.hasOwnProperty;
function arrayLikeKeys$2(value, inherited) {
  var isArr = isArray$c(value), isArg = !isArr && isArguments$2(value), isBuff = !isArr && !isArg && isBuffer$5(value), isType = !isArr && !isArg && !isBuff && isTypedArray$3(value), skipIndexes = isArr || isArg || isBuff || isType, result = skipIndexes ? baseTimes(value.length, String) : [], length = result.length;
...
var isFunction$4 = isFunction_1, isLength = isLength_1;
...
function baseForOwn$2(object2, iteratee2) {
  return object2 && baseFor$1(object2, iteratee2, keys$4);
}
...
var boolTag$2 = "[object Boolean]", dateTag$2 = "[object Date]", errorTag$2 = "[object Error]", mapTag$4 = "[object Map]", numberTag$2 = "[object Number]", regexpTag$2 = "[object RegExp]", setTag$4 = "[object Set]", stringTag$2 = "[object String]", symbolTag$2 = "[object Symbol]";
...
var DataView$2 = getNative$3(root$7, "DataView");
...
var Set$2 = getNative$1(root$5, "Set");
var _Set = Set$2;
var getNative = _getNative, root$4 = _root;
...
var mapTag$3 = "[object Map]", objectTag$3 = "[object Object]", promiseTag = "[object Promise]", setTag$3 = "[object Set]", weakMapTag$2 = "[object WeakMap]";
var dataViewTag$2 = "[object DataView]";
var dataViewCtorString = toSource(DataView$1), mapCtorString = toSource(Map$1), promiseCtorString = toSource(Promise$1), setCtorString = toSource(Set$1), weakMapCtorString = toSource(WeakMap$1);
var getTag$5 = baseGetTag$2;
if (DataView$1 && getTag$5(new DataView$1(new ArrayBuffer(1))) != dataViewTag$2 || Map$1 && getTag$5(new Map$1()) != mapTag$3 || Promise$1 && getTag$5(Promise$1.resolve()) != promiseTag || Set$1 && getTag$5(new Set$1()) != setTag$3 || WeakMap$1 && getTag$5(new WeakMap$1()) != weakMapTag$2) {
...
var Stack$3 = _Stack, equalArrays = _equalArrays, equalByTag = _equalByTag, equalObjects = _equalObjects, getTag$4 = _getTag, isArray$a = isArray_1, isBuffer$4 = isBufferExports, isTypedArray$2 = isTypedArray_1;
...
function baseIsEqualDeep$1(object2, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = isArray$a(object2), othIsArr = isArray$a(other), objTag = objIsArr ? arrayTag$1 : getTag$4(object2), othTag = othIsArr ? arrayTag$1 : getTag$4(other);
...
function isStrictComparable$2(value) {
  return value === value && !isObject$d(value);
}
...
var baseMatches = _baseMatches, baseMatchesProperty = _baseMatchesProperty, identity$3 = identity_1, isArray$9 = isArray_1, property = property_1;
...
var baseAssignValue$4 = _baseAssignValue, baseForOwn$1 = _baseForOwn, baseIteratee$2 = _baseIteratee;
function mapValues(object2, iteratee2) {
  var result = {};
  iteratee2 = baseIteratee$2(iteratee2);
  baseForOwn$1(object2, function(value, key, object3) {
    baseAssignValue$4(result, key, iteratee2(value, key, object3));
  });
  return result;
}
...
for (const method of ["validate", "validateSync"]) BaseSchema.prototype[`${method}At`] = function(path, value, options = {}) {
  ...
  return schema[method](parent2 && parent2[parentPath], _extends$2({}, options, {
    parent: parent2,
    path
  }));
};
...
var baseAssignValue$3 = _baseAssignValue, baseForOwn = _baseForOwn, baseIteratee$1 = _baseIteratee;
function mapKeys(object2, iteratee2) {
  var result = {};
  iteratee2 = baseIteratee$1(iteratee2);
  baseForOwn(object2, function(value, key, object3) {
    baseAssignValue$3(result, iteratee2(value, key, object3), value);
  });
  return result;
}
...
let isObject$c = (obj) => Object.prototype.toString.call(obj) === "[object Object]";
...
class ObjectSchema extends BaseSchema {
  ...
  _typeCheck(value) {
    return isObject$c(value) || typeof value === "function";
  }
...
function initCloneObject$2(object2) {
  return typeof object2.constructor == "function" && !isPrototype$1(object2) ? baseCreate$1(getPrototype$2(object2)) : {};
}
...
var isObject$a = isObject_1, isPrototype = _isPrototype, nativeKeysIn = _nativeKeysIn;
...
var assignMergeValue$1 = _assignMergeValue, cloneBuffer$1 = _cloneBufferExports, cloneTypedArray$1 = _cloneTypedArray, copyArray$3 = _copyArray, initCloneObject$1 = _initCloneObject, isArguments$1 = isArguments_1, isArray$8 = isArray_1, isArrayLikeObject = isArrayLikeObject_1, isBuffer$3 = isBufferExports, isFunction$3 = isFunction_1, isObject$9 = isObject_1, isPlainObject$7 = isPlainObject_1, isTypedArray$1 = isTypedArray_1, safeGet$1 = _safeGet, toPlainObject = toPlainObject_1;
function baseMergeDeep$1(object2, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    var isArr = isArray$8(srcValue), isBuff = !isArr && isBuffer$3(srcValue), isTyped = !isArr && !isBuff && isTypedArray$1(srcValue);
    newValue = srcValue;
    ...
    } else if (isPlainObject$7(srcValue) || isArguments$1(srcValue)) {
      newValue = objValue;
...
var Stack$1 = _Stack, assignMergeValue = _assignMergeValue, baseFor = _baseFor, baseMergeDeep = _baseMergeDeep, isObject$8 = isObject_1, keysIn$3 = keysIn_1, safeGet = _safeGet;
...
var baseSetToString$1 = !defineProperty ? identity$2 : function(func2, string2) {
...
var eq = eq_1, isArrayLike = isArrayLike_1, isIndex$2 = _isIndex, isObject$7 = isObject_1;
function isIterateeCall$1(value, index2, object2) {
  if (!isObject$7(object2)) {
    return false;
  }
  var type2 = typeof index2;
  if (type2 == "number" ? isArrayLike(object2) && isIndex$2(index2, object2.length) : type2 == "string" && index2 in object2) {
...
var assignValue$1 = _assignValue, castPath$3 = _castPath, isIndex$1 = _isIndex, isObject$6 = isObject_1, toKey$2 = _toKey;
function baseSet$1(object2, path, value, customizer) {
  ...
  while (nested != null && ++index2 < length) {
    ...
    if (index2 != lastIndex) {
      ...
      if (newValue === void 0) {
        newValue = isObject$6(objValue) ? objValue : isIndex$1(path[index2 + 1]) ? [] : {};
      }
    }
...
function basePickBy$1(object2, paths, predicate) {
  ...
  while (++index2 < length) {
    ...
    if (predicate(value, path)) {
      baseSet(result, castPath$2(path, object2), value);
    }
  }
  return result;
}
...
curry.placeholder = {};
var curry_1 = curry;
var baseGetTag = _baseGetTag, isObjectLike$1 = isObjectLike_1, isPlainObject$3 = isPlainObject_1;
...
function isError$1(value) {
  ...
  return tag == errorTag || tag == domExcTag || typeof value.message == "string" && typeof value.name == "string" && !isPlainObject$3(value);
}
...
const isObject$2 = (obj) => obj !== null && typeof obj === "object" && !Array.isArray(obj);
...
const [FormProvider] = createContext("Form", {
  disabled: false,
  errors: {},
  initialValues: {},
  isSubmitting: false,
...
const Form = /* @__PURE__ */ React__namespace.forwardRef(({ disabled = false, method, onSubmit, initialErrors, ...props }, ref2) => {
...
const reducer = (state, action) => fn(state, (draft) => {
  switch (action.type) {
    ...
    case "ADD_FIELD_ROW": {
      ...
      const [key] = generateNKeysBetween(position > 0 ? currentField.at(position - 1)?.__temp_key__ : null, currentField.at(position)?.__temp_key__);
...
const RedirectModal = ({
  ...
  const validationSchema = create().shape({
    source: create$1().required("Source is required"),
    destination: create$1().required("Destination is required"),
    permanent: create$2()
  });
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { onOpenChange: handleCloseRedirectModal, open: visible, labelledBy: "title", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Title, { id: "title", children: selectedRedirect ? formatMessage({
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      Form,
      {
        ...
        height: "100%",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid.Root, { gap: 4, gridCols: 12, children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 5, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "source", error: formErrors.source, children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
                id: getTranslation("modal.redirect.field.source"),
                defaultMessage: "Source"
              }) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Input, { type: "text", name: "source", value: source, onChange: handleChange }),
              formErrors.source && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Error, { children: formErrors.source })
            ] }) }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 5, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { name: "destination", error: formErrors.destination, children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: formatMessage({
              ...
              formErrors.destination && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Error, { children: formErrors.destination })
            ] }) }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid.Item, { col: 2, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { alignItems: "center", height: "100%", paddingTop: "16px", children: /* @__PURE__ */ jsxRuntime.jsx(
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Footer, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Close, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "tertiary", onClick: handleCloseRedirectModal, children: formatMessage({
              id: getTranslation("modal.cancel"),
              defaultMessage: "Cancel"
            }) }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { type: "submit", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Check, {}), children: formatMessage({ id: "modal.redirect.confirm", defaultMessage: "Save" }) })
          ] })
        ]
      },
      selectedRedirect ? selectedRedirect.documentId : "new"
    )
  ] }) });
};
const RedirectAlert = () => {
  const { form, model } = admin$1.unstable_useContentManagerContext();
  ...
  const fetchSettings = async () => {
    try {
      const res = await get2(`/${PLUGIN_ID}/settings`);
  ...
  React.useEffect(() => {
    ...
    const modelSettings = settings.find((s2) => s2.uid === modelUID);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 4, background: "neutral100", shadow: "tableShadow", children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { marginBottom: 2, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { variant: "omega", children: [
      "The field ",
      /* @__PURE__ */ jsxRuntime.jsx("strong", { children: settings.find((s2) => s2.uid === model)?.field || "UID" }),
      " has changed. Would you like to create a redirect?"
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => setModalVisible(true), variant: "secondary", size: "S", children: "Create Redirect" }),
    modalVisible && /* @__PURE__ */ jsxRuntime.jsx(
      RedirectModal,
      {
...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsxRuntime.jsx(
  "path",
  {
    d: "M6.54545 4.72727H20.1818C20.4229 4.72727 20.6542 4.82305 20.8246 4.99354C20.9951 5.16403 21.0909 5.39525 21.0909 5.63636V12H19.2727V6.54545H6.54545V9.27273L2 5.63636L6.54545 2V4.72727ZM17.4545 19.2727H3.81818C3.57707 19.2727 3.34585 19.1769 3.17535 19.0065C3.00487 18.836 2.90909 18.6047 2.90909 18.3636V12H4.72727V17.4545H17.4545V14.7273L22 18.3636L17.4545 22V19.2727Z",
    fill: "#8E8EA9"
  }
) });
const index = {
