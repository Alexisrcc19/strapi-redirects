...
import { unstable_useContentManagerContext, useFetchClient as useFetchClient$1 } from "@strapi/strapi/admin";
import { Flex, Box, Popover, Typography, Button, LinkButton, Link, Portal, Alert, useCallbackRef, useComposedRefs, Field, SubNav, Badge, Modal, Grid, Checkbox } from "@strapi/design-system";
...
const Form = /* @__PURE__ */ React.forwardRef(({ disabled = false, method, onSubmit, initialErrors, ...props }, ref2) => {
...
const RedirectModal = ({
  ...
  return /* @__PURE__ */ jsx(Modal.Root, { onOpenChange: handleCloseRedirectModal, open: visible, labelledBy: "title", children: /* @__PURE__ */ jsxs(Modal.Content, { children: [
    /* @__PURE__ */ jsx(Modal.Header, { children: /* @__PURE__ */ jsx(Modal.Title, { id: "title", children: selectedRedirect ? formatMessage({
    ...
    /* @__PURE__ */ jsxs(
      Form,
      {
        ...
        height: "100%",
        children: [
          /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsxs(Grid.Root, { gap: 4, gridCols: 12, children: [
            /* @__PURE__ */ jsx(Grid.Item, { col: 5, children: /* @__PURE__ */ jsx(Box, { width: "100%", children: /* @__PURE__ */ jsxs(Field.Root, { name: "source", error: formErrors.source, children: [
              /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
                id: getTranslation("modal.redirect.field.source"),
                defaultMessage: "Source"
              }) }),
              /* @__PURE__ */ jsx(Field.Input, { type: "text", name: "source", value: source, onChange: handleChange }),
              formErrors.source && /* @__PURE__ */ jsx(Field.Error, { children: formErrors.source })
            ] }) }) }),
            /* @__PURE__ */ jsx(Grid.Item, { col: 5, children: /* @__PURE__ */ jsx(Box, { width: "100%", children: /* @__PURE__ */ jsxs(Field.Root, { name: "destination", error: formErrors.destination, children: [
              /* @__PURE__ */ jsx(Field.Label, { children: formatMessage({
              ...
              formErrors.destination && /* @__PURE__ */ jsx(Field.Error, { children: formErrors.destination })
            ] }) }) }),
            /* @__PURE__ */ jsx(Grid.Item, { col: 2, children: /* @__PURE__ */ jsx(Box, { width: "100%", height: "100%", children: /* @__PURE__ */ jsx(Flex, { alignItems: "center", height: "100%", paddingTop: "16px", children: /* @__PURE__ */ jsx(
              Checkbox,
              {
                name: "permanent",
                checked: permanent,
          ...
          /* @__PURE__ */ jsxs(Modal.Footer, { children: [
            /* @__PURE__ */ jsx(Modal.Close, { children: /* @__PURE__ */ jsx(Button, { variant: "tertiary", onClick: handleCloseRedirectModal, children: formatMessage({
              id: getTranslation("modal.cancel"),
              defaultMessage: "Cancel"
            }) }) }),
            /* @__PURE__ */ jsx(Button, { type: "submit", startIcon: /* @__PURE__ */ jsx(Check, {}), children: formatMessage({ id: "modal.redirect.confirm", defaultMessage: "Save" }) })
          ] })
        ]
      },
...
const RedirectAlert = () => {
  ...
  const { get: get2 } = useFetchClient$1();
  ...
  return /* @__PURE__ */ jsxs(Box, { padding: 4, background: "neutral100", shadow: "tableShadow", children: [
    /* @__PURE__ */ jsx(Box, { marginBottom: 2, children: /* @__PURE__ */ jsxs(Typography, { variant: "omega", children: [
      "The field ",
      /* @__PURE__ */ jsx("strong", { children: settings.find((s2) => s2.uid === model)?.field || "UID" }),
      " has changed. Would you like to create a redirect?"
    ] }) }),
    /* @__PURE__ */ jsx(Button, { onClick: () => setModalVisible(true), variant: "secondary", size: "S", children: "Create Redirect" }),
    modalVisible && /* @__PURE__ */ jsx(
      RedirectModal,
      {
...
const PluginIcon = () => /* @__PURE__ */ jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx(
  "path",
  {
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-BnLNkhW7.mjs");
        return App;
      }
    });
      ...
      [
        {
          ...
          Component: async () => {
            const { Settings } = await import("./Settings-CnbLMi_h.mjs");
            return Settings;
          }
        }
      ]
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-CWW2YxeM.mjs") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
